...
const circle = new Circle({ name : 'circle' , cx : 50 , cy : 40 , r : 10 , fill : colors.ACACIA , children : List([]) })
const rectangle = new Rectangle({ name : 'rectangle' , x : 60 , y : 10 , width : 30 , height : 30 , fill : colors.ACACIA , children : List([]) })
const circle2 = new Circle({ name : 'circle' , cx : 10 , cy : 10 , r : 10 , fill : colors.LILAS , children : List([]) })
